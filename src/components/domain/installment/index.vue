            ...
            <div class="w-full xl:w-3/5">
                    ...
                    <div class="flex flex-wrap sm:flex-nowrap gap-4">
                        ...
                        <div class="w-full sm:w-[70%] flex flex-col gap-4">
                            <div class="flex flex-wrap sm:flex-nowrap gap-4">
                                ...
                                placeholder="AA"
                                :type="maxlengthSeriesPassport == 2 ?  'latin' : 'latin&number'"
                                class="max-w-[55px]"
                ...
                <div class="flex flex-col gap-4 mt-4">
                    ...
                    <div class="flex flex-wrap sm:flex-nowrap gap-4">
                        ...
                        <PrimarySelect class="w-full sm:w-[20%]" label="Пол" :list="gender"
                        :active="info.gender"
                    ...
                    <div class="w-full w-2/3 flex flex-wrap sm:flex-nowrap gap-4">
                        <Input
                        id="street"
...
export default {
    ...
    methods: {
        ...
        async printout() {
            ...
            if(!this.isScan) {
                if(moment(oldBirthDate).isAfter(nowDate)) {
                    let alert = {
                        isShow: true,
                ...
                // if(moment(birthDate).isBefore(dateDocIssue)) {
                //     let payload = {
                //         request: 'registrations/generate-application-pdf',
                //         body: {
                //             "phoneNumber": this.info.phoneNumber,
        ...
        filterScan() {
            ...
            if(this.info.docType == 4 || this.info.docType == 3) {
                if(this.info.phoneNumber.length > 0 && this.info.simNumber.length > 0 && this.info.docType.length > 0 && this.changedPhoneNumber.number.length > 0 && this.kontrolAmount.status == 'success' && this.info.regionId.length > 0 && this.info.passportSerial.length > 0 && this.info.regionId.length > 0 && this.info.passportNumber.length > 0 && this.info.docIssue.length == 10 && dateDocIssue < date && this.info.surname.length > 0 && this.info.name.length > 0 && this.info.patronymic.length > 0 && this.info.birthDate.length == 10 && dateBirth < date && this.info.docAuthority.length > 0 && this.info.localityType.length > 0 && this.info.city.length > 0 && this.info.streetAddress.length > 0 && this.info.houseNo.length > 0 && this.info.apartmentNumber.length > 0 && this.activeTariff.technicalPriceplan.length > 0){
                    this.isScan = false
                    this.isStatus = false
                } else {
                ...
                if(this.info.phoneNumber.length > 0 && this.info.simNumber.length > 0 && this.info.pinfl.length > 0 && this.changedPhoneNumber.number.length > 0 && this.kontrolAmount.status == 'success' && this.info.regionId.length > 0 && this.info.docType.length > 0 && this.info.regionId.length > 0 && this.info.passportSerial.length == 2 && this.info.passportNumber.length > 0 && this.info.docIssue.length == 10 && dateDocIssue < date && this.info.surname.length > 0 && this.info.name.length > 0 && this.info.patronymic.length > 0 && this.info.birthDate.length == 10 && dateBirth < date && this.info.docAuthority.length > 0 && this.info.localityType.length > 0 && this.info.city.length > 0 && this.info.streetAddress.length > 0 && this.info.houseNo.length > 0 && this.info.apartmentNumber.length > 0 && this.activeTariff.technicalPriceplan.length > 0){
                    this.isScan = false
                    this.isStatus = false
                } else {
                    this.isSuccess = false
